...
func CreatedEndpoint[S, I, T, D any](operation Operation, execute func(S, context.Context, *I) (T, error), convert func(T) D, location func(D) string) Route[S] {
...
func ItemEndpoint[S, I, T, D any](operation Operation, execute func(S, context.Context, *I) (T, error), convert func(T) D) Route[S] {
...
func PageEndpoint[B interface{ ~pageFields[D] }, S, I, T, D any](operation Operation, execute func(S, context.Context, *I) (pagination.Result[T], error), convert func(T) D) Route[S] {
	operation.DefaultStatus = http.StatusOK
